...
///   ::= identifier '(' expression* ')' [function references]
...
// BinopPrecedence - This holds the precedence for each binary operator is
// defined
...
{
	// First, check for an existing function from a previous
	// 'extern' declaration
